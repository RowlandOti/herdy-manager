...
import co.herdy.manager.presentation.userfeature.view.activity.UserListActivity;
...
public class UserListFragment extends ABaseFragment implements IUserListView {
    ...
    public interface UserListListener {
        void onUserClicked(final String userModel);
    }
    ...
    public void onAttach(Activity activity) {
        ...
        // Set the ToolBar
        ((UserListActivity) getActivity()).setToolbar(mToolbar, false, true, 0);
    }
    ...
    @Override
    public void renderUserList(Collection<String> userModelCollection) {
    ...
    @Override
    public void viewUser(String userModel) {
    ...
    private void setupRecyclerView() {
        ...
        this.rv_users.setLayoutManager(new UserLinearLayoutManager(context()));
    ...
    private UserAdapter.OnItemClickListener onItemClickListener =
            new UserAdapter.OnItemClickListener() {
                @Override
                public void onUserItemClicked(String userModel) {
