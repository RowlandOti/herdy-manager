...
import co.herdy.manager.presentation.onboarderfeature.view.CircleIndicatorView;
...
public abstract class AOnBoarderActivity extends ABaseActivity implements View.OnClickListener {
    ...
    public void setOnboardPagesReady(List<OnBoarder> pages) {
        ...
        mCircleIndicatorView.setPageIndicators(pages.size());
    }

    public void setInactiveIndicatorColor(int color) {
        this.mCircleIndicatorView.setInactiveIndicatorColor(color);
    }

    public void setActiveIndicatorColor(int color) {
        this.mCircleIndicatorView.setActiveIndicatorColor(color);
    }
