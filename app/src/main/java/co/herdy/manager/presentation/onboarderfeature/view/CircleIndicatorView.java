...
public class CircleIndicatorView extends View {
    ...
    private void init(Context context) {
        ...
        activeIndicatorPaint.setColor(ContextCompat.getColor(context, R.color.app_color_active_indicator));
        activeIndicatorPaint.setAntiAlias(true);
        inactiveIndicatorPaint = new Paint();
        inactiveIndicatorPaint.setColor(ContextCompat.getColor(context, R.color.app_color_inactive_indicator));
