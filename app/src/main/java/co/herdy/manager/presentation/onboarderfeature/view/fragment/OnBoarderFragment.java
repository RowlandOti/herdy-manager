package co.herdy.manager.presentation.onboarderfeature.view.fragment;
...
public class OnBoarderFragment extends ABaseFragment {
    ...
    @Bind(R.id.iv_onboarder_image)
    ImageView ivOnboarderImage;
    @Bind(R.id.tv_onboarder_title)
    TextView tvOnboarderTitle;
    @Bind(R.id.tv_onboarder_description)
    TextView tvOnboarderDescription;
