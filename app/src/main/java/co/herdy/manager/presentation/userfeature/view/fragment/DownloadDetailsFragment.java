...
import co.herdy.manager.presentation.userfeature.presenter.DownloadDetailsPresenter;
...
public class DownloadDetailsFragment extends ABaseFragment implements IDownloadDetailsView {
    ...
    @Inject
    DownloadDetailsPresenter userDetailsPresenter;
    ...
    @Override
    public void renderDownload(DownloadModel user) {
        if (user != null) {
