...
import co.herdy.manager.presentation.dashboardfeature.view.adapter.LitterAdapter;
 ...
 */
public class LitterFragment extends ABaseFragment {
    
    // The class Log identifier
    private static final String LOG_TAG = LitterFragment.class.getSimpleName();
    ...
    private LitterAdapter mDueAdapter;
    ...
    public static LitterFragment newInstance(Bundle args) {
        LitterFragment fragmentInstance = new LitterFragment();
        if (args != null) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_litter, container, false);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mDueAdapter = new LitterAdapter(mAnimalList);
